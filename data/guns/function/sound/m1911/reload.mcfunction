# Somente atirador
execute if entity @s[tag=!sc] at @s run playsound guns:m1911.reload weather @s ~ ~ ~ 0.5
execute if entity @s[tag=sc] at @s run playsound guns:m1911.reload_speed weather @s ~ ~ ~ 0.5
