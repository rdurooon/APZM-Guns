...
execute if score @s pap matches 1 run playsound guns:common.pap_sound weather @s ~ ~ ~ 0.5
...
execute if score @s pap matches 1 run playsound guns:common.pap_sound weather @a ~ ~ ~ 0.25